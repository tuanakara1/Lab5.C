...
string passGen(int num_words) {
    ...
    if (num_words < 3 || num_words > 7) {
        cout << "Error: Number of words must be between 3 and 7, inclusive." << endl;
...
int main() {
    int user_number;
    cout << "Enter the number of words to be used in the password (between 3 and 7): ";
    cin >> user_number;
